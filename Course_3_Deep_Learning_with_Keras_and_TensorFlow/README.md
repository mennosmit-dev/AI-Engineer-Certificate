...
- `detecing_fruits`: Developed a classifcation model to detect fruits, finetuned based on VGG16 model. By fine-tuning increased vaidation accuracy from 58% to 92% meaning rougly 57% increase. Used advanced data augmentation techniques for the supervised part to improve generalisation.
