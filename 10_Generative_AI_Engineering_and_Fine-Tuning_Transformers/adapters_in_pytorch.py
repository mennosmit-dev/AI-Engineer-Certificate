# -*- coding: utf-8 -*-
"""Adapters in PyTorch.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1AZCJ92kkHhAF9wHK9tEEvU_ugBwPCNtr
...
class FeatureAdapter(nn.Module):
    """
    Attributes:
        bottleneck_size (int): The bottleneck dimension to which the embeddings are temporarily reduced.
...
for i in range(1):
    excersise_model.linear_relu_stack[2*i] = Adapted(excersise_model.linear_relu_stack[2*i], bottleneck_size=30)

excersise_model.linear_relu_stack[4] =  nn.Linear(512, 5)
