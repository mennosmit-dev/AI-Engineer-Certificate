...
Original file is located at
    https://colab.research.google.com/drive/13t1l6B1KR-HDrBKNTlD_1jk89mydtuyM
...
predicted_label = model(text, offsets) # Even though model not optimsised can stil lcheck output size.
