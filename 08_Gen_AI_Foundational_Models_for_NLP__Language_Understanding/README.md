...
- `FNN_LanguageModel.py`: Building a gneral feed forward neural network (FNN) to predict rap words. Compared 2-gram, 4-gram, and 8-gram in terms of their perplexity over training epoch. 
- ``: 
