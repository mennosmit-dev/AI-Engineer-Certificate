...
<img src="Images/embeddings 4-gram.png" alt="Translation Spanisch<->English.." width="200"/>  <img src="Images/perplexity.png" alt="Translation Spanisch<->English.." width="200"/>
- ``: 
