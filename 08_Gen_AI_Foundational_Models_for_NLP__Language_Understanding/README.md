...
<img src="Images/embeddings 4-gram.png" alt="Translation Spanisch<->English.." width="300"/>  <img src="Images/perplexity.png" alt="Translation Spanisch<->English.." width="200"/>
- ``: 
